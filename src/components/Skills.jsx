        ...
        <div className='w-full h-auto bg-sky-200 dark:bg-dark-back flex flex-col'>
            <div className='flex justify-center h-auto mt-40 items-center flex-col space-y-2'>
                ...
                <div className='flex justify-center items.center flex-row pb-5 flex-wrap'>
                    ...
                    <div className='flex justify-center items-center flex-col'>
                        <svg version="1.0" className='fill-black dark:fill-white h-20 w-[6.5rem] mt-6' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 168 188">
                    ...
                    <div className='flex justify-center items-center flex-col'> 
                        <SiScikitlearn className='mt-4 mb-4 w-[6.5rem]' size={72}/> 
                        <div className='text-base'>Scikit-learn</div> 
                    </div>
                    <div className='flex justify-center items-center flex-col'>
                        <svg className='stroke-black dark:stroke-white fill-black dark:fill-white h-20 w-[6.5rem] mt-6' xmlns="http://www.w3.org/2000/svg" stroke="gray" viewBox="0 0 180 200">
                ...
                <div className='flex justify-center items.center flex-row pb-5 flex-wrap'>
                    ...
                    <div className='flex justify-center items-center flex-col'> 
                        <SiNetlify className='mt-4 mb-4 w-[6.5rem]' size={72}/> 
